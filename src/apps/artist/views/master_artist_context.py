...
class M_ArtistContextViewSet(CommonResponseMixin, viewsets.ModelViewSet):
    ...
    # ------------------------------------------------------------------
    # 一覧取得 (GET /master_artist_contexts/)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 登録 (POST /master_artist_contexts/)
    # ------------------------------------------------------------------
    @logging_process_with_sql
    ...
    # ------------------------------------------------------------------
    # 詳細取得 (GET /master_artist_contexts/{id}/)
    # ------------------------------------------------------------------
    @logging_process_with_sql
    ...
    # ------------------------------------------------------------------
    # 更新 (PUT/PATCH /master_artist_contexts/{id}/)
    # ------------------------------------------------------------------
    @logging_process_with_sql
    ...
    # ------------------------------------------------------------------
    # 削除 (DELETE /master_artist_contexts/{id}/)
    # ------------------------------------------------------------------
    @logging_process_with_sql
