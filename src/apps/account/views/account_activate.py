...
# --- アカウントモジュール ---
from apps.account.serializer.account_activate import AccountActivateSerializer
...
class AccountActivateView(APIView):
    ...
    def account_activate(self, request, *args, **kwargs):
        ...
        self.account_service.activate_user(date_now, KINO_ID, raw_token=serializer.validated_data.get("token"))
        response_param = {
